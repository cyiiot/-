...
* @{
*/
#define PRODUCT_KEY "4cb28b06e44346a0a704ad08f735339e"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "377c56c9b85e4474904b1c0510af1f99"
...
typedef enum
{
    LED_Color_VALUE0 = 0,//自定义 1.黄色 2.紫色 3.橙色
    LED_Color_VALUE_MAX,
} LED_Color_ENUM_T;
